...
<p><span class="rules_rule"><i>1.9</i></span> - Приобретённые предметы/услуги в магазине, не подлежат возврату, обмену или переносу на другой сервер/аккаунт.</p>\
...
<p>— Вы разрешаете устанавливать сторонние программы нужные администрации для проверки вашего PC (AnyDesk, RCC и т.д)</p>\
<p>— Вы разрешаете проверять ПК, социальные сети и почту на наличие стороннего ПО или следов приобретения стороннего ПО</p>\
</div><div class="unban" style="background: white; border-radius: 10px; padding: 20px;"><p class="MsoNormal" style="font-weight: bold; margin-bottom: 5px;">Возможность разблокровки</p><span>Через месяц после блокировки можно подать апелляцию, но, только в случае если бан был получен не за читы или макросы. Писать апелляцию нужно в личные сообщения отдельной группы: <a href="https://vk.com/bloodappeal">vk.com/bloodappeal</a><div class="unbanwarn">⚠ Учтите, блокировки не обсуждаются, поэтому писать в основную группу, в чат дискорда/телеграма или куда-бы то ни было ещё - абсолютно бессмысленно, вне группы для апелляций разблокировку не получить, ни при каких обстоятельствах.</div></span></div></div></div>'
};
...
<input class="spoil-button" type="checkbox" tabindex="-1">\
     <div class="spoil-box">\
         <span class="spoil-close fa"></span><span class="spoil-open fa"></span><span class="spoil-head">Требования к обмену при пополнении</span>\
...
//<span class="skin-warning">обязательно прочти</span>
